package com.whataplabs.whatap.global.exception.handler;
...
import static com.whataplabs.whatap.global.response.ErrorCode.*;
...
class GlobalExceptionHandlerTest {
  ...
  void handleBusinessException() throws Exception {
    mockMvc
        ...
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.businessCode").value(TEST_EXCEPTION_VALUE.getCode()))
        .andDo(print());
  }
...
//  }
  ...
  static class TestController {
    ...
    public String executeBusinessException(@PathVariable Long id) {
      throw new BusinessException(TEST_EXCEPTION_VALUE);
    }
